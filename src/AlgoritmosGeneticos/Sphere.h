...
#ifndef ALGORITMOSGENETICOS_SPHERE_H_
#define ALGORITMOSGENETICOS_SPHERE_H_

/**
 * Taken from: https://just4cool.wordpress.com/2010/01/27/algoritmos-geneticos-un-ejemplo-simple/
 */
...
#endif /* ALGORITMOSGENETICOS_SPHERE_H_ */
